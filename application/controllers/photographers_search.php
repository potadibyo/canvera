...
class Photographers_search extends CI_Controller {
	...
	function photographersearch() {
         ...
         if($this->input->post('submit')=='Find')
		{
			  $city_name                   = trim($this->input->post('city-name'));
			$category_name                   = trim($this->input->post('category-name'));
			 $data["city_name"]  = $city_name;
			 $data["category_name"]  = $category_name;
			 $data['photographersearchbycitycategory']=$this->photographer->get_photographer_bycity($city_name,$category_name);
			// echo "<pre>";
		   //print_r($data);
		}
	   ...
	   //echo "<pre>";
		//print_r($data);
			//echo "<pre>";
	//print_r($data);
        $this->load->view('includes/header', array('title'=>'Canvera.com - photographer profile'));
       $this->load->view('search_by_city_photographer_profile',$data);
        //$this->load->view('includes/footer');
